    ...
    static void run() {
        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            while (testcases-- > 0) {
                ...
                DisjointUnionSets d1 = new DisjointUnionSets(n + 1);
                for (int i = 0; i < m1; i++) d1.union(r.ni() - 1, r.ni() - 1);

                DisjointUnionSets d2 = new DisjointUnionSets(n + 1);
                for (int i = 0; i < m2; i++) d2.union(r.ni() - 1, r.ni() - 1);
                ...
                for (Pair ele : list) {
                    out.write((ele.first + " ").getBytes());
                    out.write((ele.second + " ").getBytes());
                    out.write(("\n").getBytes());
                }
