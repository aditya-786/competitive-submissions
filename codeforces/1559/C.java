    ...
    static void run() {
        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            while (testcases-- > 0) {
                ...
                for (int i = 1; i <= n; i++) arr[i] = r.nl();

                if (arr[1] == 1) {
                    out.write(((n + 1) + " ").getBytes());
                    for (int i = 1; i <= n; i++) out.write((i + " ").getBytes());
                    out.write(("\n").getBytes());
                    continue;
                }

                if (arr[n] == 0) {
                    for (int i = 1; i <= n + 1; i++) out.write((i + " ").getBytes());
                    out.write(("\n").getBytes());
                    continue;
                }
