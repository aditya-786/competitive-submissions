...
//                    if (a>max || b>max) out.write((-1 + " ").getBytes());
//                    else if (ans<=max && ans!=a && ans!=b) out.write((ans + " ").getBytes());
//                    else if (ans2>=1 && ans2<=max && ans2!=a && ans2!=b) out.write((ans2 + " ").getBytes());
//                    else out.write((-1 + " ").getBytes());

                if (a <= max && b <= max && c <= max) {
                    long res = c + (max >> 1);
                    if (res > max) res = c - (max >> 1);
