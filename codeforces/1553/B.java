       ...
       // AdityaFastIO r = new AdityaFastIO();
        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            while (testcases-- > 0) {
                ...
                StringBuilder a = new StringBuilder(r.word());
                StringBuilder b = new StringBuilder(r.word());
                ...
                for (int i=0;i<a.length();i++){
                    int j = 0;
                    int count1 = i;
                    if (j < b.length() && a.charAt(count1) == b.charAt(j)) {
                        do {
                            j++;
                            int count2 = count1 - 1;
                            count1++;
                            int pos = j;
                            if (pos < b.length() && count2 >= 0 && a.charAt(count2) == b.charAt(pos)) {
                                do {
                                    count2--;
                                    pos++;
                                } while (pos < b.length() && count2 >= 0 && a.charAt(count2) == b.charAt(pos));
                            }
                            if (pos == b.length()) {
                                ff = true;
                                break;
                            }
                        } while (j < b.length() && count1 < a.length() && a.charAt(count1) == b.charAt(j));
                    }
                }
