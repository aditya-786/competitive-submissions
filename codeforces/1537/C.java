    ...
    static void run() {
        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            while (testcases-- > 0) {
                ...
                int ind = 0;
                for (int i=1;i<n-1;i++){
                    if (list.get(ind+1) - list.get(ind) > list.get(i+1)-list.get(i)) ind = i;
                }

                out.write((list.get(ind) + " ").getBytes());
                for (int i=ind+2;i<n;i++) out.write((list.get(i) + " ").getBytes());
                for (int i=0;i<ind;i++) out.write((list.get(i) + " ").getBytes());
                out.write((list.get(ind + 1) + " ").getBytes());
                out.write(("\n").getBytes());
