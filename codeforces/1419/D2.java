    ...
    public static void main(String[] args) throws java.lang.Exception
    {
        try
        {
            ...
            try(OutputStream out = new BufferedOutputStream(System.out))
            {
                ...
                {
                    out.write((0+"\n").getBytes());
                    for (long i : list) out.write((i+" ").getBytes());
                }
                else
                {
                    int k = 0;
                    for (int i=1;i<n;i+=2) arr[i] = list.get(k++);
                    for (int i=0;i<n;i+=2) arr[i] = list.get(k++);
                    ...
                    {
                        k = i;
                        if (arr[i]<arr[k-1] && arr[i]<arr[k+1]) count++;
                    }
                    ...
                    for (long i : arr) out.write((i+" ").getBytes());
                }
