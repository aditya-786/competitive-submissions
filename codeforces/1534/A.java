        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            while (testcases-- > 0) {
                ...
                for (int i = 0; i < n; i++) {
                    for (int j = 0; j < m; j++) {
                        if (i != 0 || j != 0)
                            red[i][j] = j == 0 ? red[i - 1][j] == 'R' ? 'W' : 'R' : red[i][j - 1] == 'R' ? 'W' : 'R';
                        else red[i][j] = 'R';
                ...
                for (int i = 0; i < n; i++) {
                    for (int j = 0; j < m; j++) {
                        if (i != 0 || j != 0) {
                            if (j == 0) {
                                white[i][j] = white[i - 1][j] == 'R' ? 'W' : 'R';
                            } else {
                                white[i][j] = white[i][j - 1] == 'R' ? 'W' : 'R';
                            }
                        } else {
                            white[i][j] = 'W';
                        }
